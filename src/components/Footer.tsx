...
export const Footer = () => (
  <div className="bottom-0 flex-row items-center bg-bkg-4 h-16 w-full px-2 md:px-8 xl:px-52 2xl:px-72 flex justify-between">
    <div className=" flex items-center h-max flex-row gap-x-2 md:gap-x-3">
      <button className="rounded-full bg-brand-deepPink100 w-8 h-8 md:w-9 md:h-9 text-center text-white flex justify-center items-center hover:opacity-80">
    ...
    <div className=" flex items-center h-max flex-row">
      <div className="flex items-center h-max flex-row hover:opacity-60">
        <button className="rounded-full px-1 md:px-3 text-white font-poppins text-sm flex flex-row items-center">
          <img src={Download} alt="" className="mr-1.5 w-4 md:w-5" />
          DOWNLOAD
        </button>
      </div>
      <div className="flex items-center h-max flex-row hover:opacity-60">
        <button className="rounded-full px-1 text-white font-poppins text-sm flex flex-row items-center">
